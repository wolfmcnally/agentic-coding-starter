...
| [Skill](https://aipatternbook.com/skill) | `.claude/skills/{kickoff,methodology,learn,teach,roles,sweep,demo,treatise,plain,stamp}/SKILL.md` | Ten packaged workflows. `roles` is a thin intelligence wrapper over a deterministic script; `sweep` is the user-gated maintenance half of the lessons flywheel. |
