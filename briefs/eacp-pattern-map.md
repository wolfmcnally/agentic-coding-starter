...
| [Agent Provenance](https://aipatternbook.com/agent-provenance) | `kickoff` Step 10 END block | Requested model, effort and venue are reported separately from qualified provider observations, with missing observations explicitly unreported. Failed dispatch evidence survives governed recovery; selected model and effort cannot silently change. Any authorized venue difference carries its reason and authority. |
