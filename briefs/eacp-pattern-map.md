...
| Pattern | Where it lives | Notes |
|---|---|---|
| [Feedforward](https://aipatternbook.com/feedforward) | `policies/` (22 files), `briefs/`, `CLAUDE.md` | The entire `policies/` directory is a feedforward surface: rules that constrain the first attempt rather than grade the result. |
