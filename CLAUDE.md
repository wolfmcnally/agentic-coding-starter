...
- `bin/` — the repo's deterministic executables: the mechanistic half of the
  ...
  universal `kickoff-config`, `kickoff-tree-id`, `kickoff-command-zero`, `check-receipt`,
  `test-governance`,
